...
public class WalksController : ControllerBase
{
    ...
    [HttpGet]       
    ///api/walks?filterOn=Name&filterQuery=Track&sortBy=Name&isAscending=true&pageNumber=2&pageSize=5
    ...
    {
        var walks = await WalkRepository.GetAllWalksAsync(filterOn,
                                                          filterQuery,
                                                          sortBy,
                                                          isAscending,
                                                          pageNumber,
